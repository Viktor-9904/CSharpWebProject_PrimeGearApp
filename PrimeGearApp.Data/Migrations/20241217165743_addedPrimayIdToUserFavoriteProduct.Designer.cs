...
namespace PrimeGearApp.Data.Migrations
{
    ...
    [Migration("20241217165743_addedPrimayIdToUserFavoriteProduct")]
    partial class addedPrimayIdToUserFavoriteProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrimeGearApp.Data.Models.Manager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PrimeGearApp.Data.Models.Order", b =>
                {
                    ...
                    b.Property<string>("OrderToAddress")
                        .IsRequired()
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("PrimeGearApp.Data.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrimeGearApp.Data.Models.Manager", b =>
                {
                    b.HasOne("PrimeGearApp.Data.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("PrimeGearApp.Data.Models.Manager", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PrimeGearApp.Data.Models.ShoppingCart", b =>
                {
                    b.HasOne("PrimeGearApp.Data.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("PrimeGearApp.Data.Models.ShoppingCart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PrimeGearApp.Data.Models.ShoppingCartItem", b =>
                {
                    ...
                    b.HasOne("PrimeGearApp.Data.Models.ShoppingCart", "ShoppingCart")
                        .WithMany("CartItems")
